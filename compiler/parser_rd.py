...
class ParseResult:
    ...
    parse_method: str = "RecursiveDescent"
...
class RecursiveDescentParser:
    ...
    TYPE_TOKENS = frozenset({"INT", "FLOAT", "STRING", "VOID"})
    ...
    def parse(self) -> ParseResult:
        ...
        if self._peek().kind == "EOF":
            self._advance()
        return ParseResult(Program(functions, statements), list(self.errors))
